...
def setup_echo_server_client(net):
    ...
    serverApps = echoServer.Install(net.tors.Get(0))
    ...
    clientApps = echoClient.Install(ns.NodeContainer(net.tors.Get(1)))
